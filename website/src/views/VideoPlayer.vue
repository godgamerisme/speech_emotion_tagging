<template>
  <div class="container mt-5">
    <div class="d-flex gap-3">
      <video-player class="w-75" :videoSrc="videoSrc" @video-player="setVideoPlayer"/>
      <div class="d-flex flex-column gap-3 w-25">
        <patient-details
          class="card p-4"
          :session="session"
        />
        <patient-emotions class="card p-4" :emotions="emotions" :videoPlayer="videoPlayer"/>
      </div>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      emotions2: [
        ...
        { emotion: "Angry", src: "/src/assets/icons/emotions/angry.png", start: "04:01", end: "07:32" },
        { emotion: "Calm", src: "/src/assets/icons/emotions/calm.png", start: "07:32", end: "08:04" },
